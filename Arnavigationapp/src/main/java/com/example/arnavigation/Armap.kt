...
import kotlinx.android.synthetic.main.activity_armap.*

class Armap : AppCompatActivity(), MapboxMap.OnMapClickListener, OnMapReadyCallback {

    companion object {
        private val TAG = Armap::class.java.simpleName

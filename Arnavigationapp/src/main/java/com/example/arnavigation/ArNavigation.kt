...
class ArNavigation : AppCompatActivity(), RouteListener, ProgressChangeListener,
    OffRouteListener {

    companion object {
        private val TAG = ArNavigation::class.java.simpleName
        ...
        fun start(context: Activity, jsonRoute: String) {
            val intent = Intent(context, ArNavigation::class.java).apply {
